...
class __$$UpdateImplCopyWithImpl<$Res>
    extends _$HomeStateCopyWithImpl<$Res, _$UpdateImpl>
...
class _$UpdateImpl implements _Update {
  const _$UpdateImpl({required this.title});
  ...
  @override
  String toString() {
    return 'HomeState.update(title: $title)';
  }
...
abstract class _Update implements HomeState {
  const factory _Update({required final String title}) = _$UpdateImpl;
...
class _$SuccessImpl implements _Success {
  ...
  @override
  String toString() {
    return 'HomeState.success(products: $products, switchValue: $switchValue)';
  }
